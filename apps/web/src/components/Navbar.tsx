        ...
        >
            <div className="container mx-auto px-6 flex justify-between items-center">
                ...
                <Link href="/" className="group flex items-center gap-4">
                    <div className={`relative w-12 h-12 rounded-full overflow-hidden border-2 transition duration-300 ${scrolled ? 'border-accent-700' : 'border-white/50'}`}>
                        <Image
                    ...
                    <div className="flex flex-col">
                        <span className={`text-[0.55rem] font-bold tracking-[0.15em] uppercase mb-0.5 transition duration-300 ${scrolled ? 'text-slate-500' : 'text-slate-600'} whitespace-nowrap`}>
                            AKADEMİSYEN • YÖNETİCİ • ŞEHİRCİLİK
                        </span>
                        <span className={`text-xl font-bold font-serif leading-none transition duration-300 ${scrolled ? 'text-slate-900 message-blue' : 'text-slate-900'} whitespace-nowrap`}>
                            Dr. Selami Balcı
                        </span>
                    </div>
                </Link>
                ...
                {/* Mobile Menu Button */}
                <button className="xl:hidden text-slate-900 p-2">
